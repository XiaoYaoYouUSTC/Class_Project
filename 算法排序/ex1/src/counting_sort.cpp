...
//在堆中申请一个指针，之后将用该指针申请一个存储各数值元素的个数
int* C;
//在堆中申请一个指针，之后用该指针临时存储排序结果
int* B;
...
int main()
{
	...
	fp_o3 = fopen("..\\..\\output\\counting_sort\\result_3.txt", "w");
	fp_o6 = fopen("..\\..\\output\\counting_sort\\result_6.txt", "w");
	fp_o9 = fopen("..\\..\\output\\counting_sort\\result_9.txt", "w");
	fp_o12 = fopen("..\\..\\output\\counting_sort\\result_12.txt", "w");
	fp_o15 = fopen("..\\..\\output\\counting_sort\\result_15.txt", "w");
	fp_o18 = fopen("..\\..\\output\\counting_sort\\result_18.txt", "w");
	fp_time = fopen("..\\..\\output\\counting_sort\\time.txt", "w");
